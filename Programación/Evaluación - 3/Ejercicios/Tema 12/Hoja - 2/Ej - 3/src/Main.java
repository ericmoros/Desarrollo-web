...
public class Main {
	 ...
	 *            10 nombres y 10 apellidos combinándolos al azar. Hay que generar
	 *            un ArrayList de 50 alumnos para guardar el nombre, el apellido y
	 *            las notas obtenidas en tres exámenes parciales que se puntúan
	 *            entre 0 y 100.
	 * 
	 *            El programa debe: 1. Generar al azar los datos de 50 alumnos. Cada
	 *            alumno se almacenará en un elemento del ArrayList. Los datos que
	 *            queremos guardar de cada alumno son: string nombre; string
	 *            apellido; int nota1; int nota2; int nota3; 2. Después generar tres
	 *            mapas (TreeMap), uno para cada nota, donde la key será la nota por
	 *            la que ordenamos y el dato asociado un ArrayList con los índices
	 *            del vector donde aparece esa nota (puede haber varios alumnos que
	 *            tengan la misma nota). 3. Presentar un menú para poder listar la
	 *            clase por cualquiera de las tres notas en orden ascendente, es
	 *            decir ascen1ª, ascen2ª, ascen3ª. 4. Presentar en pantalla el
	 *            listado requerido
	 * 
	 *            De esta forma no hay que reordenar el ArrayList cada vez que se
	 *            pide un tipo de listado pues el ArrayList, aunque este
	 *            desordenado, es accesible en el orden de las notas según el mapa
	 *            que se recorra.
	 *
	 */
